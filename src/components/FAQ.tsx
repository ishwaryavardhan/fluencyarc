            ...
            <div className="container mx-auto px-6">
                <div className="grid lg:grid-cols-12 gap-16 items-start">
                    <div className="lg:col-span-5 space-y-8">
                        ...
                        <div className="pt-8">
                            <div className="bg-surface p-10 rounded-[2.5rem] border border-primary/10 relative overflow-hidden group">
                                ...
                                <a href="mailto:support@fluencyarc.com" className="inline-flex items-center gap-2 font-black text-primary group-hover:gap-3 transition-all underline underline-offset-4 decoration-2">
                                    Contact Support →
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        {faqs.map((faq, index) => (
                            <div
                                key={index}
                                className={`rounded-[2rem] overflow-hidden transition-all duration-300 border ${openIndex === index ? "bg-surface border-primary/20 shadow-xl shadow-primary/5" : "bg-white border-slate-100 hover:border-primary/10"}`}
                            >
                                <button
                                ...
                                >
                                    ...
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${openIndex === index ? "bg-primary text-white rotate-180" : "bg-slate-100 text-slate-400"}`}>
