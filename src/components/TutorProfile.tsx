    ...
    return (
        <section className="py-24 bg-white overflow-hidden">
            <div className="container mx-auto px-6">
                <div className="bg-purple-gradient rounded-[3rem] p-10 md:p-16 text-white relative flex flex-col md:flex-row items-center gap-16 overflow-hidden">
                    ...
                    <div className="relative z-10 w-full md:w-1/3">
                        <div className="aspect-[4/5] bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 overflow-hidden shadow-2xl relative">
                            <div className="absolute inset-0 flex items-center justify-center text-4xl font-bold opacity-20">Tutor Image</div>
